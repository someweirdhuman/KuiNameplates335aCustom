...
L["Shadow"] = true
L["Adds a shadow effect around nameplates."] = true
L["Shadow color"] = true
L["Show target glow"] = true
L["Make your target's nameplate glow"] = true
L["Target glow color"] = true
L["Show target arrows"] = true
L["Show arrows around your target's nameplate. They will inherit the color of the target glow, set above."] = true
...
L["Shadow"] = true
L["Display a shadow on all fonts"] = true
L["Monochrome"] = true
...
L["Bar color"] = true
L["The color of the cast bar during interruptible casts"] = true
L["Uninterruptible color"] = true
L["The color of the cast bar and shield during UNinterruptible casts."] = true
L["Height"] = true
...
L["Class colors"] = true
L["Class color friendly player names"] = true
L["Class color the names of friendly players and dim the names of friendly players with no class information. Note that friendly players will only become class colored once you mouse over their frames, at which point their class will be cached."] = true
L["Class color hostile players' health bars"] = true
L["Class color the health bars of hostile players, where they are attackable. This is a default interface option."] = true
L["Combo points"] = true
...
L['Change the color of a plate\'s health bar and border when you have threat on its unit.\n\nSelecting "Smart" (default) will automatically enable or disable tank mode based on your current specialisation\'s role.'] = true
L["The bar color to use when you have threat"] = true
L["Transitional color"] = true
L["The bar color to use when you are losing or gaining threat."] = true
L["Glow color"] = true
L["The glow (border) color to use when you have threat"] = true
L["Threat brackets"] = true
L["Show threat brackets"] = true
L["Show threat brackets when you have threat on a nameplate. Kind of like target arrows, but for threat. In tank mode they will inherit the bar color set above. Otherwise they will use the default glow color."] = true
L["Threat bracket scale"] = true
L["The scale of the threat bracket textures"] = true
L["Low health color"] = true
L["Change color of health bars at low health"] = true
L['Change the color of low health units\' health bars. "Low health" is determined by the "Low health value" option under "General display".'] = true
L["Override tank mode"] = true
L["When using tank mode, allow the low health color to override tank mode coloring"] = true
L["Show on enemy players"] = true
L["Show on enemy players - i.e. override class colors"] = true
L["The color to use"] = true
...
L["Only show the name of damaged nameplates, too. Their name will be colored as a percentage of health remaining."] = true
